...
func addWLAN() {
	resourceName := strcase.SnakeCase("WLAN")
	...
	getObj = map[string]any{
		"path":   "/s/{siteId}/rest/wlanconf/{id}",
		"method": "GET",
	}
	...
	deleteOp.AddRespStructure(new(WLANResponse), openapi.WithHTTPStatus(http.StatusOK), func(cu *openapi.ContentUnit) { cu.IsDefault = true })
