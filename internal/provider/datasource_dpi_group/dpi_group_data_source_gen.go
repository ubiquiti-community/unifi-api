...
func DpiGroupDataSourceSchema(ctx context.Context) schema.Schema {
...
func (t DataType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	dpiappIdsAttribute, ok := attributes["dpiapp_ids"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`dpiapp_ids is missing from object`)

		return nil, diags
	}

	dpiappIdsVal, ok := dpiappIdsAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`dpiapp_ids expected to be basetypes.ListValue, was: %T`, dpiappIdsAttribute))
	}
...
type DataValue struct {
	...
	DpiappIds    basetypes.ListValue   `tfsdk:"dpiapp_ids"`
...
func (v DataValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["dpiapp_ids"] = basetypes.ListType{
	...
	case attr.ValueStateKnown:
		...
		val, err = v.DpiappIds.ToTerraformValue(ctx)
...
func (v DataValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var dpiappIdsVal basetypes.ListValue
	switch {
	case v.DpiappIds.IsUnknown():
		dpiappIdsVal = types.ListUnknown(types.StringType)
	case v.DpiappIds.IsNull():
		dpiappIdsVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
		dpiappIdsVal, d = types.ListValue(types.StringType, v.DpiappIds.Elements())
		diags.Append(d...)
	}
...
func (v DataValue) Equal(o attr.Value) bool {
	...
	if !v.DpiappIds.Equal(other.DpiappIds) {
		return false
	}
