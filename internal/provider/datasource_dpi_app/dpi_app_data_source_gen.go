...
func DpiAppDataSourceSchema(ctx context.Context) schema.Schema {
...
func (t DataType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	catsAttribute, ok := attributes["cats"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`cats is missing from object`)

		return nil, diags
	}

	catsVal, ok := catsAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`cats expected to be basetypes.ListValue, was: %T`, catsAttribute))
	}
...
type DataValue struct {
	...
	Cats           basetypes.ListValue   `tfsdk:"cats"`
...
func (v DataValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["cats"] = basetypes.ListType{
		ElemType: types.Int64Type,
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.Cats.ToTerraformValue(ctx)
...
func (v DataValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	case v.Apps.IsUnknown():
		appsVal = types.ListUnknown(types.Int64Type)
	case v.Apps.IsNull():
		appsVal = types.ListNull(types.Int64Type)
	default:
		var d diag.Diagnostics
		appsVal, d = types.ListValue(types.Int64Type, v.Apps.Elements())
		diags.Append(d...)
	}
	...
	var catsVal basetypes.ListValue
	switch {
	case v.Cats.IsUnknown():
		catsVal = types.ListUnknown(types.Int64Type)
	case v.Cats.IsNull():
		catsVal = types.ListNull(types.Int64Type)
	default:
		var d diag.Diagnostics
		catsVal, d = types.ListValue(types.Int64Type, v.Cats.Elements())
		diags.Append(d...)
	}
