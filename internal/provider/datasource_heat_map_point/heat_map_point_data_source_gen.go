...
package datasource_heat_map_point
...
func HeatMapPointDataSourceSchema(ctx context.Context) schema.Schema {
			...
			"data": schema.ListNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"download_speed": schema.NumberAttribute{
							Computed: true,
						},
						...
						"upload_speed": schema.NumberAttribute{
							Computed: true,
						},
...
func (t DataType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	downloadSpeedAttribute, ok := attributes["download_speed"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`download_speed is missing from object`)

		return nil, diags
	}

	downloadSpeedVal, ok := downloadSpeedAttribute.(basetypes.NumberValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`download_speed expected to be basetypes.NumberValue, was: %T`, downloadSpeedAttribute))
	}

	heatmapIdAttribute, ok := attributes["heatmap_id"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`heatmap_id is missing from object`)

		return nil, diags
	}

	heatmapIdVal, ok := heatmapIdAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`heatmap_id expected to be basetypes.StringValue, was: %T`, heatmapIdAttribute))
	}
	...
	uploadSpeedAttribute, ok := attributes["upload_speed"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`upload_speed is missing from object`)

		return nil, diags
	}

	uploadSpeedVal, ok := uploadSpeedAttribute.(basetypes.NumberValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`upload_speed expected to be basetypes.NumberValue, was: %T`, uploadSpeedAttribute))
	}
	...
	return DataValue{
		...
		DownloadSpeed: downloadSpeedVal,
		HeatmapId:     heatmapIdVal,
		SiteId:        siteIdVal,
		UploadSpeed:   uploadSpeedVal,
		X:             xVal,
		Y:             yVal,
...
type DataValue struct {
	...
	DownloadSpeed basetypes.NumberValue `tfsdk:"download_speed"`
	HeatmapId     basetypes.StringValue `tfsdk:"heatmap_id"`
	SiteId        basetypes.StringValue `tfsdk:"site_id"`
	UploadSpeed   basetypes.NumberValue `tfsdk:"upload_speed"`
...
func (v DataValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["download_speed"] = basetypes.NumberType{}.TerraformType(ctx)
	attrTypes["heatmap_id"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["site_id"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["upload_speed"] = basetypes.NumberType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.DownloadSpeed.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["download_speed"] = val

		val, err = v.HeatmapId.ToTerraformValue(ctx)
		...
		val, err = v.UploadSpeed.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["upload_speed"] = val
...
func (v DataValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		...
		"download_speed": basetypes.NumberType{},
		"heatmap_id":     basetypes.StringType{},
		"site_id":        basetypes.StringType{},
		"upload_speed":   basetypes.NumberType{},
...
func (v DataValue) Equal(o attr.Value) bool {
	...
	if !v.DownloadSpeed.Equal(other.DownloadSpeed) {
		return false
	}

	if !v.HeatmapId.Equal(other.HeatmapId) {
		return false
	}
	...
	if !v.UploadSpeed.Equal(other.UploadSpeed) {
		return false
	}
