...
package datasource_virtual_device
...
func VirtualDeviceDataSourceSchema(ctx context.Context) schema.Schema {
...
func (t DataType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	yVal, ok := yAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`y expected to be basetypes.StringValue, was: %T`, yAttribute))
	}
...
type DataValue struct {
	...
	Y              basetypes.StringValue `tfsdk:"y"`
